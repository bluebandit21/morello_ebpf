...
__SC_COMP_RETPTR(__NR_rt_sigreturn, sys_rt_sigreturn, compat_sys_rt_sigreturn)
...
__SYSCALL_RETPTR(__NR_mremap, sys_mremap)
...
__SC_3264_RETPTR(__NR3264_mmap, sys_mmap2, sys_mmap)
