...
#define _PAGE_KERNEL		(PROT_NORMAL | PTE_MAYBE_LS_CAPS)
#define _PAGE_KERNEL_RO		((PROT_NORMAL & ~PTE_WRITE) | PTE_RDONLY | PTE_MAYBE_LS_CAPS)
...
#define _PAGE_READONLY		(_PAGE_DEFAULT | PTE_USER | PTE_RDONLY | PTE_NG | PTE_PXN | PTE_MAYBE_LS_CAPS | PTE_UXN)
#define _PAGE_READONLY_EXEC	(_PAGE_DEFAULT | PTE_USER | PTE_RDONLY | PTE_NG | PTE_PXN | PTE_MAYBE_LS_CAPS)
#define _PAGE_EXECONLY		(_PAGE_DEFAULT | PTE_RDONLY | PTE_NG | PTE_PXN)

#ifdef CONFIG_ARM64_MORELLO
#define PTE_MAYBE_LS_CAPS	(PTE_LOAD_CAPS | PTE_STORE_CAPS)
#else
#define PTE_MAYBE_LS_CAPS	0
#endif
